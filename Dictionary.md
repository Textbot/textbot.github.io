...
**Диаграмма Вороного** (от англ. Voronoi Cell) - разбиение k-мерного пространства с конечным множеством точек S на n (n = |S|) k-мерных областей D, где каждый элемент d_i из D_i всегда находится ближе к s_i, чем к любому другому элементу множества S.

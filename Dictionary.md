...
**Распознавание именованных сущностей** (от англ. Named Entity Recognition [NER]) - задача NLP, состоящая в выделении сегментов/чанков (см. Чанкинг) текста и присвоении каждому из них некоторого типа сущности, например, PER (имя собственное), LOC (месторасположение), ORG (организация), MISC (разное), O (несущностный) и т.д.

...
**Нулевое обучение** (от англ. Zero-shot learning) - обучение, при котором система обучается решению задачи классификации без обучающих примеров, содержащих указание классов. В частности, речь идет об обучении без учителя для задач, по формулировки предполагающих обучение с учителем.
